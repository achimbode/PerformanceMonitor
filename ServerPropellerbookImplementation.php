...
class ServerPropellerbookImplementation extends ServerImplementation {
	...
	protected $path_monitor = "/path/to/htdocs/mediawiki-1.20.8/extensions/PerformanceMonitor/";
	protected $path_logfiles = "/path/to/htdocs/mediawiki-1.20.8/logs/autologs/";
