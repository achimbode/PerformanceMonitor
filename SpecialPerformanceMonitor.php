...
class SpecialPerformanceMonitor extends SpecialPage {
	...
	public function execute( $par ) {
		global $ef_PM_filelist, $eg_PM_processes_Json, $eg_PM_processes_Json2, $eg_PM_filename, $eg_PM_filename2;
		
		$this->setHeaders();
		$output = $this->getOutput();
		$output->setPageTitle( 'PerformanceMonitor' );
		
		$this->provide_file_list();					// then stored in global $ef_PM_filelist
		...
		foreach ( $ef_PM_filelist as $key => $val ) break;
	...
	private function provide_file_list() {		
		global $ef_PM_filelist, $eg_PM_LocalServer;
	...
	*/
	...
	public static function onBeforePageDisplay() {
        //if( ProfilerSimpleJson::isPerformanceMonitorSpecialPage() ){
	...
	public static function includeHtml() {
		...
		global $eg_PM_processes_Json, $eg_PM_processes_Json2, $ef_PM_filelist, $objLogJson;
		global $eg_PM_LocalServer;
		...
		foreach ( $ef_PM_filelist as $key => $filename) {
			$filelist_as_list_entries .= '
		...
		(function() {
		  ...
		  useGradients = false; //nativeCanvasSupport;
